...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('static/css/bootstrap-responsive.css'); ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('static/css/green-theme.css'); ?>">
	...
	<script type="text/javascript" src="<?php echo base_url('static/js/tinynav.min.js'); ?>"></script>
