...
class Report_model extends CI_Model {
    function __construct() {
        ...
        $this->field = array('id', 'company_id', 'email', 'content');
    }
    ...
    function get_by_id($param) {
        ...
        if (isset($param['id'])) {
            $select_query  = "SELECT * FROM ".REPORT." WHERE id = '".$param['id']."' LIMIT 1";
        } 
    ...
    function get_array($param = array()) {
		...
		$select_query = "
			SELECT SQL_CALC_FOUND_ROWS Report.*, Company.nama company_nama
			FROM ".REPORT." Report
			LEFT JOIN ".COMPANY." Company ON Report.company_id = Company.id
